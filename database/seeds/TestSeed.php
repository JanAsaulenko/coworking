...
class TestSeed extends Seeder
{
    ...
    public function run()
    {
        $this->addTestReservation('1','2018-08-20','2018-08-23',10);
        $this->addTestReservation('1','2018-08-21','2018-08-29',10);

        $this->addTestReservation('1','2018-08-23','2018-08-30',20);
