...
@section('content')
    ...
    @if(Session::has('flash_message'))
        <div class="alert alert-dunger" style="color:red; text-align: center;">
    ...
    <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2">
        <div class="x_panel">
            <div class="x_title">
                <h2>Користувачі
                    <small>перелік привілегій, наданих користувачі</small>
                </h2>
            ...
            <div class="x_content">
                <table class="table">
                    ...
                    <tr class="table_content">
                        ...
                        <td>
                            <div class="col-md-12">
                                {{Form::button('<i class="fa fa-plus-square"></i>  Додати привілегію',  array('type' => 'submit', 'class' => 'btn btn-success btn-xs', 'style' => 'width: 100%; font-size:14px')) }}
                            </div>
                        </td>
                        {{Form::close()}}
                    </tr>
