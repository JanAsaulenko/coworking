...
<head>
  ...
  <!--Swiper -->
  <link rel="stylesheet" href="{{ asset('assets/css/swiper_place/swiper.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('assets/css/swiper_place/swiper_place.css') }}" />
  ...
  <!---->
	...
	<!-- Select2 JQUERY selector -->
	<link href="https://cdnjs.cloudf lare.com/ajax/libs/select2/4.0.3/css/select2.min.css" rel="stylesheet" />
