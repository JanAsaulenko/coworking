<footer class="footer">
    <div class="footer_location-info-block">
        <p>
    ...
    <div class="footer_partners-block">
					<span class="partners-block_title">
						Наші партнери:
					</span>
        <ul class="partners-block_list">
            <li class="partners-block_item">
    ...
    <div class="footer_sochial-block">
        <ul class="sochial-block_list">
            <li class="sochial-block_item">
                <a target="_blank" href="https://twitter.com" class="footer__social-link tw">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                         id="Capa_1" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 97.75 97.75"
            ...
            <li class="sochial-block_item">
                <a target="_blank" href="https://www.facebook.com" class="footer__social-link fb">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                         id="Capa_1" x="0px" y="0px" viewBox="0 0 167.657 167.657"
                         style="enable-background:new 0 0 167.657 167.657;" xml:space="preserve" width="512px"
                         height="512px">
										<g>
            ...
            <li class="sochial-block_item">
                <a target="_blank" href="https://www.instagram.com" class="footer__social-link ins">
                    <svg version="1.1" id="Capa_1" fill="#d0d0d0" xmlns="http://www.w3.org/2000/svg"
